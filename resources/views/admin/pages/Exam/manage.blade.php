...
@section('header_title', 'مدیریت سوالات کنکور')
@section('breadcrumb-items')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">صفحه اصلی</a></li>
    <li class="breadcrumb-item active">مدیریت سوالات کنکور</li>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-2 pb-2">
                <a href="{{ route('exams.create') }}" class="btn btn-block btn-outline-success">ایجاد</a>
            </div>
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">سوالات کنکور</h3>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach($exams as $key => $item)
                                    <tr id="row-{{ $item->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('exams.edit', $item->id) }}" class="btn btn-default"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('exams.destroy', $item->id) }}" class="btn btn-default delete" data-id="{{ $item->id }}"><i class="fa fa-remove"></i></a>
